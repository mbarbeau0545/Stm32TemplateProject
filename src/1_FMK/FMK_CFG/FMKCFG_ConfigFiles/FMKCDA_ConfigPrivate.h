...
#define FMKCDA_CONFIGPRIVATE_H_INCLUDED
    ...
    const t_sFMKCDA_HwAdcCfg c_FmkCda_HwVrefCfg[FMKCDA_ADC_NB] = {
        {FMKCDA_ADC_3,                         FMKCDA_ADC_CHANNEL_18},                // for FMKCDA_ADC_1
        {FMKCDA_ADC_3,                         FMKCDA_ADC_CHANNEL_18},                // for FMKCDA_ADC_2
    ...
    const t_sFMKCDA_ADcInternalSnsCfg c_FmkCda_HwInternalSnsCfg_as[FMKCDA_ADC_INTERN_NB] ={
        {{FMKCDA_ADC_3,                         FMKCDA_ADC_CHANNEL_16},                TRUE                          },// for FMKCDA_ADC_INTERN_VBAT
        {{FMKCDA_ADC_3,                         FMKCDA_ADC_CHANNEL_17},                TRUE                          },// for FMKCDA_ADC_INTERN_TS_CAL1
        {{FMKCDA_ADC_3,                         FMKCDA_ADC_CHANNEL_17},                FALSE                         },// for FMKCDA_ADC_INTERN_TS_CAL2
    };
