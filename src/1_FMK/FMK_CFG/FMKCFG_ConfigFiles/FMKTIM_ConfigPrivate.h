...
#define FMKTIM_CONFIGPRIVATE_H_INCLUDED
    ...
    */
    ...
    {//    Get Timer State                 Init Timer                       ²      DeInitTimer                   StartPolling Func                StopPolling Funnc             Start Interrupt Func             Stop Interrupt Func                Start Dma Func                         Stop Dma Func                     Get Init Timer Param
        {HAL_TIM_PWM_GetState,             FMKTIM_HAL_TIM_PWM_Init,                HAL_TIM_PWM_DeInit,           HAL_TIM_PWM_Start,               HAL_TIM_PWM_Stop,             HAL_TIM_PWM_Start,              HAL_TIM_PWM_Stop,                  FMKTIM_HAL_TIM_PWM_Start_DMA,          HAL_TIM_PWM_Stop_DMA,            FMKTIM_GetPwmTimerInitParam},         // FMKTIM_CHANNEL_CFG_PWM 
