...
#define FMKIO_CONFIGPRIVATE_H_INCLUDED
    ...
    #define FMKIO_TIME_BTWN_DIAG_MS ((t_uint16)2000)  
    ...
    const t_sFMKIO_BspSigCfg c_InDigSigBspMap_as[FMKIO_INPUT_SIGDIG_NB] = {
        ...
        {FMKIO_GPIO_PORT_D,             FMKIO_GPIO_PIN_10},   // FMKIO_INPUT_SIGDIG_15,
        {FMKIO_GPIO_PORT_G,             FMKIO_GPIO_PIN_15},   // FMKIO_INPUT_SIGDIG_16,
        {FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_0},    // FMKIO_INPUT_SIGDIG_17,
        {FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_1},    // FMKIO_INPUT_SIGDIG_18,
        {FMKIO_GPIO_PORT_B,             FMKIO_GPIO_PIN_5},    // FMKIO_INPUT_SIGDIG_19,
    };
    ...
    const t_sFMKIO_BspSigCfg c_OutDigSigBspMap_as[FMKIO_OUTPUT_SIGDIG_NB] = {
        ...
        {FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_12},   // FMKIO_OUTPUT_SIGDIG_20,
        {FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_15},   // FMKIO_OUTPUT_SIGDIG_21,
        {FMKIO_GPIO_PORT_G,             FMKIO_GPIO_PIN_8},    // FMKIO_OUTPUT_SIGDIG_22,
    };
    ...
    const t_sFMKIO_BspTimerSigCfg c_OutPwmSigBspMap_as[FMKIO_OUTPUT_SIGPWM_NB] = {
        ...
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_0},              GPIO_AF2_TIM5,                 (t_uint8)FMKTIM_INTERRUPT_LINE_IO_111,                       FMKIO_ITLINE_TYPE_BSCTIM},    // FMKIO_OUTPUT_SIGPWM_5,
        {{FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_9},              GPIO_AF1_TIM1,                 (t_uint8)FMKTIM_INTERRUPT_LINE_IO_11,                        FMKIO_ITLINE_TYPE_ADVTIM},    // FMKIO_OUTPUT_SIGPWM_6,
        {{FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_11},             GPIO_AF1_TIM1,                 (t_uint8)FMKTIM_INTERRUPT_LINE_IO_12,                        FMKIO_ITLINE_TYPE_ADVTIM},    // FMKIO_OUTPUT_SIGPWM_7,
        {{FMKIO_GPIO_PORT_E,             FMKIO_GPIO_PIN_13},             GPIO_AF1_TIM1,                 (t_uint8)FMKTIM_INTERRUPT_LINE_IO_13,                        FMKIO_ITLINE_TYPE_ADVTIM},    // FMKIO_OUTPUT_SIGPWM_8,
        ...
        {{FMKIO_GPIO_PORT_G,             FMKIO_GPIO_PIN_6},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_9,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_10,
        {{FMKIO_GPIO_PORT_G,             FMKIO_GPIO_PIN_7},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_10,                                  FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_11,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_6},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_1,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_12,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_7},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_2,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_13,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_8},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_4,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_14,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_9},              GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_5,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_15,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_10},             GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_6,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_16,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_11},             GPIO_AF2_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_7,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_17,
    };
    ...
    const t_sFMKIO_BspEcdrCfg c_FmkIo_InEcdrSigBspCfg_as[FMKIO_INPUT_ENCODER_NB] =  {
        ...
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_6},              {FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_7},             GPIO_AF2_TIM3,                 FMKTIM_INTERRUPT_LINE_IO_91}, // FMKIO_INPUT_ENCODER_3
    };
    ...
    const t_sFMKIO_RxTxComCfg c_FmkIo_SerialSigCfg_as[FMKIO_COM_SIGNAL_SERIAL_NB] ={
        ...
        {{FMKIO_GPIO_PORT_D,             FMKIO_GPIO_PIN_9},              {FMKIO_GPIO_PORT_D,             FMKIO_GPIO_PIN_8},             GPIO_AF7_USART3}, // FMKIO_COM_SIGNAL_SERIAL_3
