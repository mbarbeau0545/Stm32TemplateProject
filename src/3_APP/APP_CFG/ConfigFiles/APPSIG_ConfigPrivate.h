...
#define APPSIG_CONFIGPRIVATE_H_INCLUDED
    ...
    // *                      Types
    // ********************************************************************
    ///@brief message sending policies 
    typedef enum
    {
        APPSIG_TX_POLICY_ONCHANGE = 0,
        APPSIG_TX_POLICY_FORCE,
    ...
    //  Identifier                                          Direction                                                CyclicSend                                                 TimeOut                                                         Sig Cfg                                         nbSignal
        {APPSIG_SRL_ID_APPLICATIONINFO1,                         APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_TX},          (t_uint16)500,                                          (t_uint16)0,                                            c_AppSig_Srl_ApplicationInfo1_as,                       (t_uint8)15}, // APPSIG_SRL_APPLICATIONINFO1
    };
